...
[![Build Status](https://api.travis-ci.org/VirgilSecurity/virgil-crypto-x.svg?branch=master)](https://travis-ci.org/VirgilSecurity/virgil-crypto-x)
...
```
github "VirgilSecurity/virgil-crypto-x" ~> 3.1.5
```
